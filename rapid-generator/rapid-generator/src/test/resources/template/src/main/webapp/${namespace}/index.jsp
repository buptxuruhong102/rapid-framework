            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                ...
                <div class="navbar-header">
                    <ul class="nav navbar-nav navbar-left" id="side-menu">
                        ...
                        <#list menuNames as menu>
                            <li>
                                <a href="<@jspEl 'ctx'/>/${menu}/index" class="J_menuItem J_home"><i class="fa fa-file"></i> <span class="nav-label">${menu}</span></a>
                            </li>
                        </#list>
                    </ul>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<@jspEl 'ctx'/>/logout">退出系统</a></li>
                        </ul>
                    </li>
